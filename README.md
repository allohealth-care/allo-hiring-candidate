...
During the interview process, you will be asked to extend the application according to requirements provided by the interviewer. You are expected to review the codebase and have the application fully set up and running before the interview begins in IDE with AI capabilities (`Antigravity/VS Code/Cursor with Copilot, Claude`).
